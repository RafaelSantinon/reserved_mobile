    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={styles.detailsContainer}>
          <Text style={styles.description} >Restaurante: Teste 01</Text>
          <Text style={styles.description} >Mesa: 10</Text>
          <Text style={styles.description} >Status: Confirmada</Text>

          <RectButton style={{...styles.button, marginBottom: 8}} onPress={() => {
